    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (id) {
            ...
            R.id.nav_table -> {
                ...
                val banAnFragment = BanAnFragment()
                tranDisplayTable.replace(R.id.contentView, banAnFragment)
            ...
            R.id.nav_staff -> {
                ...
                val nhanVienFragment = NhanVienFragment()
                tranDisplayStaff.replace(R.id.contentView, nhanVienFragment)
