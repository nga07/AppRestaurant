...
class BanAnAdapter(var context: Context, var layout: Int, var banAnList: List<BanAn>) :
    ...
    private var anButton:Boolean=false
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (kttinhtrang == "true") {
            viewHolder!!.imgBanAn!!.setImageResource(R.drawable.ghe11)
        } else {
            viewHolder!!.imgBanAn!!.setImageResource(R.drawable.ghe1)
        }
    ...
    private fun AnButton() {
        viewHolder!!.imgGoiMon!!.visibility = View.GONE
        viewHolder!!.imgThanhToan!!.visibility = View.GONE
        viewHolder!!.imgAnNut!!.visibility = View.GONE
    }
