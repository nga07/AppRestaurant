...
class NhanVienFragment : Fragment() {
    ...
    private fun sortData() {
        ...
        val arrayAdapter = activity?.let { NhanVienAdapter(it,R.layout.icon_nhan_vien, listNhanVien) }
    ...
    private fun HienThiDSNV() {
        ...
        nhanVienAdapter = activity?.let { NhanVienAdapter(it,R.layout.icon_nhan_vien, nhanViens!!) }
